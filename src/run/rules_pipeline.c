...
/*   Updated: 2024/02/10 19:54:39 by akeryan          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (node == NULL){
		ft_printf(2, "node in the PIPELINE is NULL\n");//delete
		return ;
	}
	int p[2];
	...
	if (fork_() == 0)
	{
		ft_printf(2, "CHILD 1 process started------------------------\n");
	...
	//if (fork_() == 0)
	//{
		//ft_printf(2, "CHILD 2 process started------------------------\n");
